...
$$
y = \sum_{i = 1}^{n} G \left(\right. x \left.\right)_{i} E_{i} \left(\right. x \left.\right)
$$
...
$$
G_{\sigma} \left(\right. x \left.\right) = \text{Softmax} \left(\right. x \cdot W_{g} \left.\right)
$$
...
$$
H \left(\right. x \left.\right)_{i} = \left(\right. x \cdot W_{\text{g}} \left.\right)_{i} + \text{StandardNormal}() \cdot \text{Softplus} \left(\right. \left(\right. x \cdot W_{\text{noise}} \left.\right)_{i} \left.\right)
$$
...
$$
G \left(\right. x \left.\right) = \text{Softmax} \left(\right. \text{KeepTopK} \left(\right. H \left(\right. x \left.\right) , k \left.\right) \left.\right)
$$
...
$$
\text{Expert Capacity} = \left(\right. \frac{\text{tokens per batch}}{\text{number of experts}} \left.\right) \times \text{capacity factor}
$$
...
- ![](https://huggingface.co/avatars/bd13e3c006573db51fcdf74b016d1aa3.svg)
...
[yangxia20000](https://huggingface.co/yangxia20000)
...
[Rangeeshv](https://huggingface.co/Rangeeshv)
...
[tm23hgf](https://huggingface.co/tm23hgf)

[Nov 29, 2025](#6929e84486855a7a2b7bb24c)
